/* 
 * This is not my code and I'm not claiming it to be
 * It is an implementation got from here:
 * https://github.com/novaua/ExpC/blob/master/glibc_hash_tbl/main.c
 */
